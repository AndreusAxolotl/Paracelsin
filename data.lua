...
add_crafting_categories("iron-gear-wheel", {"mechanics"})
add_crafting_categories("iron-stick", {"mechanics"})
add_crafting_categories("assembling-machine-1", {"mechanics"})
add_crafting_categories("assembling-machine-2", {"mechanics"})
add_crafting_categories("assembling-machine-3", {"mechanics"})
...
add_crafting_categories("car", {"mechanics"})
add_crafting_categories("tank", {"mechanics"})
add_crafting_categories("locomotive", {"mechanics"})
add_crafting_categories("cargo-wagon", {"mechanics"})
add_crafting_categories("fluid-wagon", {"mechanics"})
add_crafting_categories("artillery-wagon", {"mechanics"})
add_crafting_categories("artillery-turret", {"mechanics"})
add_crafting_categories("gun-turret", {"mechanics"})
add_crafting_categories("flamethrower-turret", {"mechanics"})
add_crafting_categories("rocket-turret", {"mechanics"})
add_crafting_categories("flamethrower", {"mechanics"})
add_crafting_categories("rocket-launcher", {"mechanics"})
add_crafting_categories("submachine-gun", {"mechanics"})
add_crafting_categories("shotgun", {"mechanics"})
add_crafting_categories("combat-shotgun", {"mechanics"})
add_crafting_categories("spidertron", {"mechanics"})
add_crafting_categories("chemical-plant", {"mechanics"})
add_crafting_categories("oil-refinery", {"mechanics"})
add_crafting_categories("crusher", {"mechanics"})
add_crafting_categories("asteroid-collector", {"mechanics"})
add_crafting_categories("thruster", {"mechanics"})
add_crafting_categories("pumpjack", {"mechanics"})
add_crafting_categories("electric-mining-drill", {"mechanics"})
add_crafting_categories("burner-mining-drill", {"mechanics"})
add_crafting_categories("copper-cable", {"mechanics"})
add_crafting_categories("centrifuge", {"mechanics"})
add_crafting_categories("space-platform-foundation", {"mechanics"})
