...
asteroid_functions.paracelsin_ratio      = {20, 3, 10, 0}
...
asteroid_functions.paracelsin_chunks      = 0.0010
asteroid_functions.paracelsin_big         = 0.0025
...
asteroid_functions.aquilo_paracelsin =
{
  has_promethium_asteroids = false,
  probability_on_range_chunk =
  {
...
asteroid_functions.paracelsin_solar_system_edge =
{
  has_promethium_asteroids = false,
  probability_on_range_chunk =
  {
    {position = 0.1, probability = asteroid_functions.paracelsin_chunks, angle_when_stopped = asteroid_functions.chunk_angle},
    {position = 0.9, probability = asteroid_functions.system_edge_chunks, angle_when_stopped = asteroid_functions.chunk_angle}
  },
  probability_on_range_big =
  {
    {position = 0.1, probability = asteroid_functions.paracelsin_big, angle_when_stopped = asteroid_functions.big_angle},
  ...
  type_ratios =
  {
    {position = 0.1, ratios = asteroid_functions.paracelsin_ratio},
    {position = 0.2, ratios = {10,3,10, 0}},
    {position = 0.3, ratios = {6,2,8, 0}},
    {position = 0.4, ratios = {7,1,4, 0}},
